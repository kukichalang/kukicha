...
//line /var/home/tluker/repos/go/kukicha/stdlib/container/container.kuki:279
	err_8 := engine.cli.ContainerStart(ctxpkg.Value(bg), resp.ID, dockercontainer.StartOptions{})
	if err_8 != nil {
...
//line /var/home/tluker/repos/go/kukicha/stdlib/container/container.kuki:421
		err_15 := json.Unmarshal(scanner.Bytes(), &msg)
		if err_15 != nil {
...
//line /var/home/tluker/repos/go/kukicha/stdlib/container/container.kuki:651
			err_16 := os.MkdirAll(target, os.FileMode(header.Mode))
			if err_16 != nil {
				return err_16
			}
		case tar.TypeReg:
//line /var/home/tluker/repos/go/kukicha/stdlib/container/container.kuki:653
			err_17 := os.MkdirAll(filepath.Dir(target), 493)
			if err_17 != nil {
				return err_17
			}
...
//line /var/home/tluker/repos/go/kukicha/stdlib/container/container.kuki:678
		err_22 := filepath.WalkDir(absSourcePath, func(walkPath string, d os.DirEntry, err error) error {
...
//line /var/home/tluker/repos/go/kukicha/stdlib/container/container.kuki:726
	err_28 := os.MkdirAll(destPath, 493)
	if err_28 != nil {
...
//line /var/home/tluker/repos/go/kukicha/stdlib/container/container.kuki:727
	err_29 := extractTar(reader, destPath)
	if err_29 != nil {
...
//line /var/home/tluker/repos/go/kukicha/stdlib/container/container.kuki:742
	err_31 := engine.cli.CopyToContainer(ctxpkg.Value(ctx), containerID, destPath, archive, copyOpts)
	if err_31 != nil {
