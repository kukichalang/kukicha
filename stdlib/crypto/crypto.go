...
//line stdlib/crypto/crypto.kuki:20
func SHA256(data string) string {
//line stdlib/crypto/crypto.kuki:21
	h := sha256.New()
//line stdlib/crypto/crypto.kuki:22
	h.Write([]byte(data))
//line stdlib/crypto/crypto.kuki:23
	return hex.EncodeToString(h.Sum(nil))
}

//line stdlib/crypto/crypto.kuki:27
...
//line stdlib/crypto/crypto.kuki:42
...
//line stdlib/crypto/crypto.kuki:53
	if error != nil {
//line stdlib/crypto/crypto.kuki:54
		return "", fmt.Errorf("crypto.RandomToken: %w", error)
	}
//line stdlib/crypto/crypto.kuki:55
...
//line stdlib/crypto/crypto.kuki:61
	_, error := rand.Read(b)
//line stdlib/crypto/crypto.kuki:62
	if error != nil {
//line stdlib/crypto/crypto.kuki:63
		return nil, fmt.Errorf("crypto.RandomBytes: %w", error)
	}
//line stdlib/crypto/crypto.kuki:64
	return b, nil
}

//line stdlib/crypto/crypto.kuki:69
func Equal(a []byte, b []byte) bool {
//line stdlib/crypto/crypto.kuki:70
