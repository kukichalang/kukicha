...
//line stdlib/db/db.kuki:22
type Pool struct {
	conn *sql.DB
}

//line stdlib/db/db.kuki:26
type Row struct {
	row *sql.Row
}

//line stdlib/db/db.kuki:30
type Rows struct {
	rows *sql.Rows
}

//line stdlib/db/db.kuki:34
type Tx struct {
	tx *sql.Tx
}

//line stdlib/db/db.kuki:38
type TxOptions struct {
	isolationLevel string
	readOnly       bool
}

//line stdlib/db/db.kuki:48
func Open(driver string, connString string) (Pool, error) {
//line stdlib/db/db.kuki:49
...
//line stdlib/db/db.kuki:51
	pool := Pool{conn: conn}
//line stdlib/db/db.kuki:52
	return pool, nil
}

//line stdlib/db/db.kuki:56
func Close(pool Pool) error {
//line stdlib/db/db.kuki:57
...
//line stdlib/db/db.kuki:111
	for rows.rows.Next() {
//line stdlib/db/db.kuki:112
		elemPtr := reflect.New(elemType)
//line stdlib/db/db.kuki:113
...
//line stdlib/db/db.kuki:129
	elemType := reflect.TypeOf(sample)
//line stdlib/db/db.kuki:130
	elemPtr := reflect.New(elemType)
//line stdlib/db/db.kuki:132
	if !rows.rows.Next() {
...
//line stdlib/db/db.kuki:134
		return sample, errors.New("db.ScanOne: no rows returned")
	}
//line stdlib/db/db.kuki:136
	fieldPtrs := structScanners(elemPtr.Elem(), elemType, columns)
...
//line stdlib/db/db.kuki:180
	tx := Tx{tx: sqlTx}
//line stdlib/db/db.kuki:182
	defer func() {
//line stdlib/db/db.kuki:183
		if //line stdlib/db/db.kuki:183
		r := recover(); r != nil {
...
//line stdlib/db/db.kuki:209
	tx := Tx{tx: sqlTx}
//line stdlib/db/db.kuki:211
	defer func() {
//line stdlib/db/db.kuki:212
		if //line stdlib/db/db.kuki:212
		r := recover(); r != nil {
//line stdlib/db/db.kuki:213
			sqlTx.Rollback()
//line stdlib/db/db.kuki:214
			panic(r)
		}
	}()
...
//line stdlib/db/db.kuki:270
	return true, nil
}

//line stdlib/db/db.kuki:278
...
//line stdlib/db/db.kuki:321
	for i := range numFields {
//line stdlib/db/db.kuki:322
		field := elemType.Field(i)
