...
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:20
	for _, tc := range cases {
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:21
		t.Run(tc.name, func(t *testing.T) {
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:22
			base := goerrors.New(tc.baseMsg)
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:23
			wrapped := errors.Wrap(base, tc.wrapMsg)
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:24
			if tc.wantEqual {
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:25
				test.AssertTrue(t, errors.Is(wrapped, base))
			} else {
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:27
				test.AssertFalse(t, errors.Is(wrapped, goerrors.New("different")))
			}
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:29
			unwrapped := errors.Unwrap(wrapped)
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:30
			if tc.wantEqual {
...
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:44
	cases := []OpaqueCase{OpaqueCase{name: "formats message", msg: "inner detail", wrapMsg: "subsystem", wantMsg: "subsystem: inner detail"}}
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:46
	for _, tc := range cases {
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:47
		t.Run(tc.name, func(t *testing.T) {
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:48
			base := goerrors.New(tc.msg)
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:49
			opaque := errors.Opaque(base, tc.wrapMsg)
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:50
			test.AssertEqual(t, opaque.Error(), tc.wantMsg)
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:52
			test.AssertFalse(t, errors.Is(opaque, base))
		})
	}
}

//line /home/user/kukicha/stdlib/errors/errors_test.kuki:58
...
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:64
...
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:84
func TestJoin(t *testing.T) {
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:85
...
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:90
			if tc.wantNil {
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:91
				test.AssertNoError(t, e)
			} else {
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:93
				test.AssertError(t, e)
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:94
				test.AssertNoError(t, nil)
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:95
				errStr := e.Error()
//line /home/user/kukicha/stdlib/errors/errors_test.kuki:96
