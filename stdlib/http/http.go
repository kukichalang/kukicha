...
//line /home/user/kukicha/stdlib/http/http.kuki:69
...
//line /home/user/kukicha/stdlib/http/http.kuki:84
const ContentMultipart = "multipart/form-data"

//line /home/user/kukicha/stdlib/http/http.kuki:89
func WithCSRF(handler http.Handler) http.Handler {
//line /home/user/kukicha/stdlib/http/http.kuki:90
...
//line /home/user/kukicha/stdlib/http/http.kuki:114
	return json.MarshalWrite(w, value)
}
...
//line /home/user/kukicha/stdlib/http/http.kuki:125
	w.Header().Set("Content-Type", "application/json")
...
//line /home/user/kukicha/stdlib/http/http.kuki:194
...
//line /home/user/kukicha/stdlib/http/http.kuki:204
...
//line /home/user/kukicha/stdlib/http/http.kuki:206
	if value == "" {
//line /home/user/kukicha/stdlib/http/http.kuki:207
		return defaultValue
	}
//line /home/user/kukicha/stdlib/http/http.kuki:208
...
//line /home/user/kukicha/stdlib/http/http.kuki:209
	return val
}
...
//line /home/user/kukicha/stdlib/http/http.kuki:217
	if value == "" {
//line /home/user/kukicha/stdlib/http/http.kuki:218
...
//line /home/user/kukicha/stdlib/http/http.kuki:227
	if value == "" {
//line /home/user/kukicha/stdlib/http/http.kuki:228
		return defaultValue
	}
...
//line /home/user/kukicha/stdlib/http/http.kuki:255
...
//line /home/user/kukicha/stdlib/http/http.kuki:287
...
//line /home/user/kukicha/stdlib/http/http.kuki:334
	w.Header().Set("Content-Security-Policy", "default-src 'self'")
}

//line /home/user/kukicha/stdlib/http/http.kuki:340
func IsGet(r *http.Request) bool {
//line /home/user/kukicha/stdlib/http/http.kuki:341
	return (r.Method == "GET")
}
...
//line /home/user/kukicha/stdlib/http/http.kuki:355
func IsDelete(r *http.Request) bool {
//line /home/user/kukicha/stdlib/http/http.kuki:356
	return (r.Method == "DELETE")
}

//line /home/user/kukicha/stdlib/http/http.kuki:360
func IsPatch(r *http.Request) bool {
//line /home/user/kukicha/stdlib/http/http.kuki:361
	return (r.Method == "PATCH")
}

//line /home/user/kukicha/stdlib/http/http.kuki:366
func MethodNotAllowed(w http.ResponseWriter, allowed ...string) {
//line /home/user/kukicha/stdlib/http/http.kuki:367
	w.Header().Set("Allow", kukistring.Join(allowed, ", "))
//line /home/user/kukicha/stdlib/http/http.kuki:368
	w.WriteHeader(405)
}

//line /home/user/kukicha/stdlib/http/http.kuki:373
func SecureHeaders(handler http.Handler) http.Handler {
//line /home/user/kukicha/stdlib/http/http.kuki:374
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
//line /home/user/kukicha/stdlib/http/http.kuki:375
		w.Header().Set("X-Content-Type-Options", "nosniff")
//line /home/user/kukicha/stdlib/http/http.kuki:376
		w.Header().Set("X-Frame-Options", "DENY")
//line /home/user/kukicha/stdlib/http/http.kuki:377
		w.Header().Set("Referrer-Policy", "strict-origin-when-cross-origin")
//line /home/user/kukicha/stdlib/http/http.kuki:378
		w.Header().Set("Content-Security-Policy", "default-src 'self'")
//line /home/user/kukicha/stdlib/http/http.kuki:379
