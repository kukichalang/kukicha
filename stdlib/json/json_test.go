...
//line /home/user/kukicha/stdlib/json/json_test.kuki:20
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:30
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:36
type UnmarshalCase struct {
	name string
}

//line /home/user/kukicha/stdlib/json/json_test.kuki:39
func TestUnmarshal(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:40
	cases := []UnmarshalCase{UnmarshalCase{name: "unmarshal person"}}
//line /home/user/kukicha/stdlib/json/json_test.kuki:42
	for _, tc := range cases {
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:48
			result := *new(Person)
//line /home/user/kukicha/stdlib/json/json_test.kuki:49
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:56
type RoundTripCase struct {
	name string
}

//line /home/user/kukicha/stdlib/json/json_test.kuki:59
func TestMarshalUnmarshalRoundTrip(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:60
	cases := []RoundTripCase{RoundTripCase{name: "round trip"}}
//line /home/user/kukicha/stdlib/json/json_test.kuki:62
	for _, tc := range cases {
//line /home/user/kukicha/stdlib/json/json_test.kuki:63
		t.Run(tc.name, func(t *testing.T) {
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:70
			test.AssertNoError(t, err2)
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:77
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:81
	cases := []MarshalPrettyCase{MarshalPrettyCase{name: "pretty print"}}
//line /home/user/kukicha/stdlib/json/json_test.kuki:83
	for _, tc := range cases {
//line /home/user/kukicha/stdlib/json/json_test.kuki:84
		t.Run(tc.name, func(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:85
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:90
			test.AssertNoError(t, err2)
//line /home/user/kukicha/stdlib/json/json_test.kuki:92
			if len(pretty) == 0 {
//line /home/user/kukicha/stdlib/json/json_test.kuki:93
				t.Error("Expected non-empty pretty JSON bytes")
			}
//line /home/user/kukicha/stdlib/json/json_test.kuki:95
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:103
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:106
	for _, tc := range cases {
//line /home/user/kukicha/stdlib/json/json_test.kuki:107
		t.Run(tc.name, func(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:108
			p := Person{Name: "Eve", Age: 22}
//line /home/user/kukicha/stdlib/json/json_test.kuki:109
			buf := bytes.Buffer{}
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:120
func TestUnmarshalRead(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:121
	cases := []UnmarshalReadCase{UnmarshalReadCase{name: "read from buffer"}}
//line /home/user/kukicha/stdlib/json/json_test.kuki:123
	for _, tc := range cases {
//line /home/user/kukicha/stdlib/json/json_test.kuki:124
		t.Run(tc.name, func(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:125
			p := Person{Name: "Frank", Age: 35}
//line /home/user/kukicha/stdlib/json/json_test.kuki:126
			buf := bytes.Buffer{}
//line /home/user/kukicha/stdlib/json/json_test.kuki:127
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:141
func TestEncode(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:142
	cases := []EncodeCase{EncodeCase{name: "encode to buffer"}}
//line /home/user/kukicha/stdlib/json/json_test.kuki:144
	for _, tc := range cases {
//line /home/user/kukicha/stdlib/json/json_test.kuki:145
		t.Run(tc.name, func(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:146
			p := Person{Name: "Grace", Age: 29}
//line /home/user/kukicha/stdlib/json/json_test.kuki:147
			buf := bytes.Buffer{}
//line /home/user/kukicha/stdlib/json/json_test.kuki:148
			enc := json.NewEncoder(&buf)
//line /home/user/kukicha/stdlib/json/json_test.kuki:149
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:160
	cases := []DecodeCase{DecodeCase{name: "decode from buffer"}}
//line /home/user/kukicha/stdlib/json/json_test.kuki:162
	for _, tc := range cases {
//line /home/user/kukicha/stdlib/json/json_test.kuki:163
		t.Run(tc.name, func(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:164
			p := Person{Name: "Hank", Age: 40}
//line /home/user/kukicha/stdlib/json/json_test.kuki:165
			buf := bytes.Buffer{}
//line /home/user/kukicha/stdlib/json/json_test.kuki:166
			enc := json.NewEncoder(&buf)
//line /home/user/kukicha/stdlib/json/json_test.kuki:167
			encErr := json.Encode(enc, p)
//line /home/user/kukicha/stdlib/json/json_test.kuki:168
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:185
	for _, tc := range cases {
//line /home/user/kukicha/stdlib/json/json_test.kuki:186
		t.Run(tc.name, func(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:187
			p := Person{Name: "Iris", Age: 33}
//line /home/user/kukicha/stdlib/json/json_test.kuki:188
			buf := bytes.Buffer{}
//line /home/user/kukicha/stdlib/json/json_test.kuki:189
			enc := json.WithIndent(json.NewEncoder(&buf), "  ")
//line /home/user/kukicha/stdlib/json/json_test.kuki:190
			err := json.Encode(enc, p)
//line /home/user/kukicha/stdlib/json/json_test.kuki:191
			test.AssertNoError(t, err)
//line /home/user/kukicha/stdlib/json/json_test.kuki:192
			if buf.Len() == 0 {
...
//line /home/user/kukicha/stdlib/json/json_test.kuki:203
	for _, tc := range cases {
//line /home/user/kukicha/stdlib/json/json_test.kuki:204
		t.Run(tc.name, func(t *testing.T) {
//line /home/user/kukicha/stdlib/json/json_test.kuki:205
			invalid := []byte("not valid json")
//line /home/user/kukicha/stdlib/json/json_test.kuki:206
			result := *new(Person)
//line /home/user/kukicha/stdlib/json/json_test.kuki:207
			err := json.Unmarshal(invalid, &result)
//line /home/user/kukicha/stdlib/json/json_test.kuki:208
